        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 sm:p-8">
          ...
          <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-100 dark:border-gray-700/50">
            ...
            <div className="space-y-1">
              <p className="text-xs text-gray-400"><span className="font-mono">Superadmin</span> / <span className="font-mono">Admin12345</span></p>
              <p className="text-xs text-gray-400"><span className="font-mono">customer1</span> / <span className="font-mono">customer123</span></p>
            </div>
          </div>
        </div>
      </div>
