...
const AVAILABLE_WIDGETS = {
  stats_total_users:     { label: 'Total Users',     displayType: 'stat_card',  roles: ['SUPERADMIN'] },
  stats_buildings:       { label: 'Total Buildings',  displayType: 'stat_card',  roles: ['SUPERADMIN'] },
  stats_restaurants:     { label: 'Total Restaurants',displayType: 'stat_card',  roles: ['SUPERADMIN','BUILDING_MANAGER','RESTAURANT_MANAGER','CHEF'] },
  stats_orders:          { label: 'Total Orders',     displayType: 'stat_card',  roles: ['SUPERADMIN','BUILDING_MANAGER','RESTAURANT_MANAGER','CHEF'] },
  stats_revenue:         { label: 'Total Revenue',    displayType: 'stat_card',  roles: ['SUPERADMIN','BUILDING_MANAGER','RESTAURANT_MANAGER'] },
  stats_pending_orders:  { label: 'Pending Orders',   displayType: 'stat_card',  roles: ['SUPERADMIN','BUILDING_MANAGER','RESTAURANT_MANAGER','CHEF'] },
  stats_preparing:       { label: 'In Preparation',   displayType: 'stat_card',  roles: ['SUPERADMIN','BUILDING_MANAGER','RESTAURANT_MANAGER','CHEF'] },
  stats_completed_today: { label: 'Delivered Today',  displayType: 'stat_card',  roles: ['SUPERADMIN','BUILDING_MANAGER','RESTAURANT_MANAGER','CHEF'] },
  users_by_role:         { label: 'Users by Role',    displayType: 'progress',  roles: ['SUPERADMIN'] },
  orders_by_status:      { label: 'Orders by Status', displayType: 'status_bar',roles: ['SUPERADMIN','BUILDING_MANAGER','RESTAURANT_MANAGER','CHEF'] },
  recent_orders:         { label: 'Recent Orders',    displayType: 'list',      roles: ['SUPERADMIN','BUILDING_MANAGER','RESTAURANT_MANAGER','CHEF'] },
  popular_items:         { label: 'Popular Items',    displayType: 'ranked_list',roles: ['SUPERADMIN','BUILDING_MANAGER','RESTAURANT_MANAGER','CHEF'] },
  buildings_list:        { label: 'Buildings',        displayType: 'list',      roles: ['SUPERADMIN'] },
  restaurants_list:      { label: 'Restaurants',      displayType: 'list',      roles: ['SUPERADMIN','BUILDING_MANAGER'] },
  quick_actions:         { label: 'Quick Actions',    displayType: 'action_grid',roles: ['SUPERADMIN','BUILDING_MANAGER','RESTAURANT_MANAGER','CHEF'] },
  building_reports:      { label: 'Building Reports', displayType: 'table',     roles: ['SUPERADMIN'] },
  restaurant_reports:    { label: 'Restaurant Reports',displayType: 'table',    roles: ['SUPERADMIN'] },
  revenue_chart:         { label: 'Revenue Chart',    displayType: 'bar_chart', roles: ['SUPERADMIN','BUILDING_MANAGER','RESTAURANT_MANAGER'] },
  food_card_overview:    { label: 'Food Card',        displayType: 'food_card', roles: ['CUSTOMER','SUPERADMIN','BUILDING_MANAGER','RESTAURANT_MANAGER'] },
};
